...
class AuthApi {
  ...
  Future<Response<void>> deconnexion({ 
    ...
    final _path = r'/auth/deconnexion';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Accepte] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Accepte>> demander({ 
    required DemandeOtp demandeOtp,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/otp/demander';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(DemandeOtp);
      _bodyData = _serializers.serialize(demandeOtp, specifiedType: _type);
    ...
    Accepte? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Accepte),
      ) as Accepte;
  ...
  Future<Response<ResultatVerification>> inscrire({ 
    ...
    final _path = r'/auth/inscription';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(Inscription);
      _bodyData = _serializers.serialize(inscription, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [JetonsDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JetonsDto>> rafraichir({ 
    required DemandeRafraichissement demandeRafraichissement,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(DemandeRafraichissement);
      _bodyData = _serializers.serialize(demandeRafraichissement, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ResultatVerification] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ResultatVerification>> verifier({ 
    ...
    final _path = r'/auth/otp/verifier';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(VerificationOtp);
      _bodyData = _serializers.serialize(verificationOtp, specifiedType: _type);
