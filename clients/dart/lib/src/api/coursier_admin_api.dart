...
class CoursierAdminApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ExpositionCash] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExpositionCash>> expositionCash({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/coursiers/exposition';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ExpositionCash? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ExpositionCash),
      ) as ExpositionCash;
    ...
    return Response<ExpositionCash>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [etat] - `demandee` | `validee` | `refusee`. Absent = toutes.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FileIndemnisations] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FileIndemnisations>> fileIndemnisations({ 
    String? etat,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/indemnisations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    FileIndemnisations? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FileIndemnisations),
      ) as FileIndemnisations;
    ...
    return Response<FileIndemnisations>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [indemnisationId] - Indemnisation à refuser.
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IndemnisationDecidee] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IndemnisationDecidee>> refuserIndemnisation({ 
    required String indemnisationId,
    required DecisionIndemnisation decisionIndemnisation,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/indemnisations/{indemnisation_id}/refuser'.replaceAll('{' r'indemnisation_id' '}', encodeQueryParameter(_serializers, indemnisationId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(DecisionIndemnisation);
      _bodyData = _serializers.serialize(decisionIndemnisation, specifiedType: _type);
    ...
    IndemnisationDecidee? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(IndemnisationDecidee),
      ) as IndemnisationDecidee;
    ...
    return Response<IndemnisationDecidee>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [indemnisationId] - Indemnisation à valider.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [IndemnisationDecidee] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IndemnisationDecidee>> validerIndemnisation({ 
    required String indemnisationId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/indemnisations/{indemnisation_id}/valider'.replaceAll('{' r'indemnisation_id' '}', encodeQueryParameter(_serializers, indemnisationId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
