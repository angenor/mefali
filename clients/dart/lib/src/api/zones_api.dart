...
class ZonesApi {
  ...
  ///
  /// Parameters:
  /// * [zone] - Zone dont on veut la configuration effective.
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ConfigZone] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConfigZone>> config({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'zone': encodeQueryParameter(_serializers, zone, const FullType(String)),
    };
    ...
    ConfigZone? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConfigZone),
      ) as ConfigZone;
