...
- [X] T029 [US6] `CLAUDE.md` : ajouter à la section « Règles impératives » que la gestion d'état des apps Flutter est **Riverpod codegen** (provider généré, injection par la portée, les deux moules, état local qui reste local) — **même règle que la constitution, sans la contredire** (FR-041). Dépend de T028. (½ j)
