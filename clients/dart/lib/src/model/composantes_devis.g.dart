...
part of 'composantes_devis.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ComposantesDevis extends ComposantesDevis {
  @override
  final int arrondi;
  @override
  final int base_;
  ...
  factory _$ComposantesDevis(
          [void Function(ComposantesDevisBuilder)? updates]) =>
      (ComposantesDevisBuilder()..update(updates))._build();

  _$ComposantesDevis._(
      ...
      : super._();
  @override
  ComposantesDevis rebuild(void Function(ComposantesDevisBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ComposantesDevisBuilder toBuilder() =>
      ComposantesDevisBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ComposantesDevis &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ComposantesDevis')
          ..add('arrondi', arrondi)
          ..add('base_', base_)
...
class ComposantesDevisBuilder
    implements Builder<ComposantesDevis, ComposantesDevisBuilder> {
  _$ComposantesDevis? _$v;
  ...
  ComposantesDevisBuilder() {
    ComposantesDevis._defaults(this);
  }

  ComposantesDevisBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _arrondi = $v.arrondi;
      _base_ = $v.base_;
  ...
  @override
  void replace(ComposantesDevis other) {
    _$v = other as _$ComposantesDevis;
  }

  @override
  void update(void Function(ComposantesDevisBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ComposantesDevis build() => _build();

  _$ComposantesDevis _build() {
    final _$result = _$v ??
        _$ComposantesDevis._(
          arrondi: BuiltValueNullFieldError.checkNotNull(
              arrondi, r'ComposantesDevis', 'arrondi'),
          base_: BuiltValueNullFieldError.checkNotNull(
              base_, r'ComposantesDevis', 'base_'),
          effortArrets: BuiltValueNullFieldError.checkNotNull(
              effortArrets, r'ComposantesDevis', 'effortArrets'),
          effortAttente: BuiltValueNullFieldError.checkNotNull(
              effortAttente, r'ComposantesDevis', 'effortAttente'),
          effortPaliers: BuiltValueNullFieldError.checkNotNull(
              effortPaliers, r'ComposantesDevis', 'effortPaliers'),
          km: BuiltValueNullFieldError.checkNotNull(
              km, r'ComposantesDevis', 'km'),
          retenueVendeur: BuiltValueNullFieldError.checkNotNull(
              retenueVendeur, r'ComposantesDevis', 'retenueVendeur'),
          supplements: BuiltValueNullFieldError.checkNotNull(
              supplements, r'ComposantesDevis', 'supplements'),
        );
    replace(_$result);
    return _$result;
  }
