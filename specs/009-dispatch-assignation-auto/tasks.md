...
- [ ] T071 **(NON FAITE — requiert un appareil)** Validation `quickstart.md` sur émulateur Android — dérouler SC-001 à SC-015 avec l'API sur IP LAN, position de l'émulateur sur Tiassalé (`adb emu geo fix -4.8210 5.8960`), et consigner les défauts trouvés. Les cycles 006 et 008 ont tous deux trouvé de vrais bugs à cette étape : la prévoir pleine, pas en marge.
