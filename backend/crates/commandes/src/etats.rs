...
const TRANSITIONS: &[Transition] = &[
    ...
    Transition { niveau: Niveau::Commande, depuis: None, vers: "nouvelle",
                 acteurs: &[Acteur::Client] },
    Transition { niveau: Niveau::Commande, depuis: None, vers: "en_attente_paiement",
                 acteurs: &[Acteur::Client] },
    // Paiement confirmé (PAY, simulé ce cycle).
    Transition { niveau: Niveau::Commande, depuis: Some("en_attente_paiement"), vers: "nouvelle",
                 acteurs: &[Acteur::Systeme] },
    // Expiration du prépaiement, ou renoncement du client.
    Transition { niveau: Niveau::Commande, depuis: Some("en_attente_paiement"), vers: "annulee",
    ...
    Transition { niveau: Niveau::Commande, depuis: Some("en_attente_coursier"), vers: "en_cours",
                 acteurs: &[Acteur::Systeme] },
    // Annulation SANS FRAIS depuis l'attente.
    Transition { niveau: Niveau::Commande, depuis: Some("en_attente_coursier"), vers: "annulee",
                 acteurs: &[Acteur::Client, Acteur::Admin] },
    // Annulation SANS FRAIS avant toute prise en charge.
    Transition { niveau: Niveau::Commande, depuis: Some("nouvelle"), vers: "annulee",
                 acteurs: &[Acteur::Client, Acteur::Admin] },
    // Remise effectuée.
    Transition { niveau: Niveau::Commande, depuis: Some("en_cours"), vers: "terminee",
                 acteurs: &[Acteur::Coursier] },
    // Annulation en course : règles CMD-08 dès qu'un arrêt est collecté.
    Transition { niveau: Niveau::Commande, depuis: Some("en_cours"), vers: "annulee",
                 acteurs: &[Acteur::Client, Acteur::Admin] },
    // Échec déclaré, PREUVES RÉUNIES (FR-056).
    Transition { niveau: Niveau::Commande, depuis: Some("en_cours"), vers: "echouee",
                 acteurs: &[Acteur::Coursier, Acteur::Admin] },

    // ── Composant `livraison` (data-model §3.2) ───────────────────────────
    Transition { niveau: Niveau::Livraison, depuis: None, vers: "assignee",
                 acteurs: &[Acteur::Systeme] },
    // Premier arrêt passé en route.
    Transition { niveau: Niveau::Livraison, depuis: Some("assignee"), vers: "en_collecte",
                 acteurs: &[Acteur::Coursier] },
    // TOUTES les collectes résolues (gating corrigé, P1/R4).
    Transition { niveau: Niveau::Livraison, depuis: Some("en_collecte"), vers: "en_livraison",
                 acteurs: &[Acteur::Coursier] },
    // Remise validée (QR, code ou dépôt).
    Transition { niveau: Niveau::Livraison, depuis: Some("en_livraison"), vers: "livree",
                 acteurs: &[Acteur::Coursier] },
    // Annulation de la commande, à n'importe quel stade de travail.
    Transition { niveau: Niveau::Livraison, depuis: Some("assignee"), vers: "annulee",
                 acteurs: &[Acteur::Client, Acteur::Admin, Acteur::Systeme] },
    Transition { niveau: Niveau::Livraison, depuis: Some("en_collecte"), vers: "annulee",
                 acteurs: &[Acteur::Client, Acteur::Admin, Acteur::Systeme] },
    Transition { niveau: Niveau::Livraison, depuis: Some("en_livraison"), vers: "annulee",
                 acteurs: &[Acteur::Client, Acteur::Admin, Acteur::Systeme] },
    // Échec déclaré avec preuves.
    Transition { niveau: Niveau::Livraison, depuis: Some("en_livraison"), vers: "echouee",
                 acteurs: &[Acteur::Coursier, Acteur::Admin] },

    // ── `arret` (data-model §3.3) ─────────────────────────────────────────
    Transition { niveau: Niveau::Arret, depuis: Some("a_collecter"), vers: "en_route",
                 acteurs: &[Acteur::Coursier] },
    Transition { niveau: Niveau::Arret, depuis: Some("en_route"), vers: "arrive",
                 acteurs: &[Acteur::Coursier] },
    // Scan QR ou code de secours — chemin NOMINAL de la boucle CMD-04.
    Transition { niveau: Niveau::Arret, depuis: Some("arrive"), vers: "collecte",
                 acteurs: &[Acteur::Coursier] },
    ...
    Transition { niveau: Niveau::Arret, depuis: Some("a_collecter"), vers: "collecte",
                 acteurs: &[Acteur::Coursier] },
    // Toutes les lignes de l'arrêt retirées ou refusées.
    Transition { niveau: Niveau::Arret, depuis: Some("arrive"), vers: "indisponible",
                 acteurs: &[Acteur::Coursier] },
    // Vendeur fermé constaté, avant ou pendant le trajet.
    Transition { niveau: Niveau::Arret, depuis: Some("a_collecter"), vers: "indisponible",
                 acteurs: &[Acteur::Coursier] },
    Transition { niveau: Niveau::Arret, depuis: Some("en_route"), vers: "indisponible",
                 acteurs: &[Acteur::Coursier] },
];
...
mod tests {
    ...
    fn chemin_direct_du_cycle_006_conserve() {
        ...
        verifier_transition(Niveau::Arret, Some("a_collecter"), "collecte", Acteur::Coursier)
    ...
    fn transition_absente_refusee() {
        ...
        let e =
            verifier_transition(Niveau::Livraison, Some("assignee"), "livree", Acteur::Coursier)
                .unwrap_err();
        assert_eq!(e.message_cle(), Some("transition_refusee"));

        // Revenir en arrière sur le tronc.
        assert!(
            verifier_transition(Niveau::Commande, Some("en_cours"), "nouvelle", Acteur::Systeme)
                .is_err()
        );
